...
\caption{Global annual gross primary production (GPP) and net ecosystem production (NEP) across the PPE within each of our six forcing scenarios. Each point represents a simulation within the PPE. Points are spaced horizontally to minimize overlap.}
\label{fig:violins}
\end{figure}
