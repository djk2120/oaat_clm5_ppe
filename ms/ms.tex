...
\caption{Global annual gross primary production (GPP) and net ecosystem production (NEP) across the PPE within each of our six forcing scenarios. Circles are drawn for 5 and 0.1 PgC bins respectively, with the circle size proportional to the number of simulations falling in that bin. The default parameterization are marked with `x'.}
\label{fig:violins}
\end{figure}
