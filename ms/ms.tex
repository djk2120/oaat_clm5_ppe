...
\label{sect:md}
This experiment utilizes the Community Land Model configuration version 5.1 (CLM5.1) of the Community Terrestrial Systems Model. The model source code and documentation are available online (\url{https://github.com/ESCOMP/CTSM}), as is a full model description \cite{lawrence2019}. (I again can't figure out how to comment, but this maybe involve a discussion on model naming (CTSM vs. CLM))
