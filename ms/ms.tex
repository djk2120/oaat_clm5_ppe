...
PPEs also form a basis for automated model calibration through, for example, history matching \cite{williamson2013} or Bayesian uncertainty quantification (Cleary et al. 2021 JCP).
