...
Understanding how these variables respond to CO$_2$ concentration, and how we expect CO$_2$ concentration to evolve over time, is at the center of climate change research.  
...
But with the ever-increasing observational basis from remote sensing, meteorological stations, flux towers, and field campaigns, we might expect predictions to become more skillful across subsequent model generations.
...
PPEs have played an important role in assessing projection uncertainty in climate models (Hawkins 2019 JAMES).
